...
const SHAIVA_SIDDHANTA_DEFAULTS = ["maha-shivaratri-shaiva", "pradosha-shaiva", "aarudra-darshan", "karthigai-deepam-shaiva", "skanda-shashti-shaiva", "thai-poosam-shaiva", "aadi-krittikai-shaiva", "ugadi-telugu", "vara-lakshmi-vratam", "dasara-vijayadashami-telugu", "sankranti-telugu", "kartika-masam-telugu", "satyanarayan-pooja-telugu"];
