...
function AumVedicSvg({ className = "", style }: { className?: string; style?: CSSProperties }) {
  // Vedic Aum (ओ३म्) — saffron flame rising from a havan kund (yajna fire altar)
  return (
    <svg viewBox="0 0 48 48" className={className} fill="none" style={style} aria-hidden="true">
      {/* Havan kund (square pyramid base) */}
      ...
      {/* Aum dot/chandrabindu — three sparks above flame */}
            ...
            <div className="space-y-3">
              {(
                ...
                [
                  ...
                  {
                    value: "AryaSamaj" as Tradition,
                    label: "Arya Samaj (Vedic Dharma)",
                    subtitle: "Daily Sandhya & Havan, Sthapana Diwas, Dayananda Jayanti, Veda Prakatya",
                    icon: <AumVedicSvg className="w-12 h-12" style={{ color: "#9A3412" }} />,
                    accent: "#9A3412",
                  },
                  {
